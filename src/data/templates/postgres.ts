...
export const postgresTemplate: ComponentTemplate = {
    ...
    d1: {
      ...
      nodes: [
        ...
        { id: 'schema',   label: 'Schema',          drillable: false },
        {
          ...
          tooltip: 'Click body to cross-link. Click ↓ to drill into row-level model.',
          d2: {
            ...
            nodes: [
              ...
              { id: 'column',     label: 'Column',        drillable: false },
              {
                ...
                tooltip: 'Click body to cross-link. Click ↓ to see B-tree page internals.',
                d3: {
                  label: 'C internals — B-tree index',
                  nodes: [
  ...
  axis2: {
    layers: [
      ...
      {
        // Postgres has no threads layer — one OS process per connection.
        // Processes that would be "threads" in other systems are separate processes here.
