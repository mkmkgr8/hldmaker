  ...
  axis1: {
    ...
    d2: {
      ...
      nodes: [
        ...
        { id: 'sorted_set', label: 'Sorted set',  drillable: true, tooltip: 'skiplist + dict maintained in sync. O(log N) range queries, O(1) by-score lookup.' },
    ...
    d3: {
      ...
      nodes: [
        ...
        { id: 'listpack_t',   label: 'listpack',           drillable: false, tooltip: 'Compact sequential encoding: total-bytes (uint32) + num-elements (uint16) + entries + 0xFF end. No pointers.' },
    ...
    layers: [
      ...
      },
      {
        ...
        components: [
          ...
          { id: 'ae_event_loop', label: 'ae (event loop lib)',drillable: false, tooltip: 'Redis\'s own event loop abstraction (ae = A simple Event driven programming library). Wraps epoll/kqueue.' },
